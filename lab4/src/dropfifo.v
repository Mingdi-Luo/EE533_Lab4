...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/ids/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_5 (.A(XLXN_27[7:0]), 
                                  .B(XLXN_23[7:0]), 
                                  .EQ(XLXN_41));
   // synthesis attribute HU_SET of XLXI_5 is "XLXI_5_18"
   COMP8_MXILINX_dropfifo XLXI_6 (.A(XLXN_23[7:0]), 
                                  .B(XLXN_36[7:0]), 
                                  .EQ(XLXN_42));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_21"
   FD XLXI_7 (.C(clk), 
              .D(drop_pkt), 
              .Q(XLXN_21));
   defparam XLXI_7.INIT = 1'b0;
   CB8CE_MXILINX_dropfifo XLXI_8 (.C(clk), 
                                  .CE(XLXN_45), 
                                  .CLR(rst), 
                                  .CEO(), 
                                  .Q(XLXN_23[7:0]), 
   ...
   VCC XLXI_13 (.P(XLXN_5));
   OR2 XLXI_14 (.I0(XLXN_11), 
                .I1(XLXN_10), 
                .O(XLXN_20));
   AND2B1 XLXI_15 (.I0(XLXN_21), 
                   .I1(XLXN_20), 
                   .O(XLXN_47));
   AND3B2 XLXI_16 (.I0(XLXN_41), 
                   .I1(XLXN_42), 
                   .I2(fiforead), 
                   .O(XLXN_45));
   dualportgate9B XLXI_20 (.addra(XLXN_27[7:0]), 
                           .addrb(XLXN_23[7:0]), 
                           .clka(clk), 
                           .clkb(clk), 
                           .dina(XLXN_26[71:0]), 
